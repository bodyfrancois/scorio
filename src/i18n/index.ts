...
const translations = {
  fr: {
    ...
    // Mini-jeux (outils rapides, sans joueurs ni score)
    coinToss: 'Pile ou Face',
    coinHeads: 'Face',
    coinTails: 'Pile',
    coinFlipButton: 'Lancer la pièce',
    coinFlipping: 'La pièce tourne…',
    coinIdleHint: 'Appuie pour lancer la pièce',

    timerTitle: 'Chrono & minuteur',
    ...
    timerSetDuration: 'Règle la durée (59 min 59 s maximum)',
    timerDone: 'Temps écoulé',
    timerMinutesLabel: 'Minutes',
    timerSecondsLabel: 'Secondes',
    timerUnitMinutes: 'min',
    timerUnitSeconds: 'sec',
    timerRange: 'Entre 0 et 59',

    buzzerTitle: 'Buzzer',
    buzzerAction: 'Buzz',
    buzzerHint: 'Appuie pour buzzer',
    buzzerCount: '{count} appuis',
    buzzerReset: 'Remettre le compteur à zéro',

    wheelTitle: 'Roue',
    wheelSpin: 'Faire tourner',
    wheelSpinning: 'La roue tourne…',
    wheelEntries: 'Entrées',
    wheelAddEntry: 'Ajouter',
    wheelRemoveEntry: 'Retirer cette entrée',
  ...
  en: {
    ...
    // Mini-games (quick tools, no players and no score)
    coinToss: 'Coin Toss',
    coinHeads: 'Heads',
    coinTails: 'Tails',
    coinFlipButton: 'Flip the coin',
    coinFlipping: 'The coin is spinning…',
    coinIdleHint: 'Tap to flip the coin',

    timerTitle: 'Stopwatch & timer',
    ...
    timerResume: 'Resume',
    timerReset: 'Reset',
    timerSetDuration: 'Set the duration (59 min 59 s maximum)',
    timerDone: "Time's up",
    timerMinutesLabel: 'Minutes',
    timerSecondsLabel: 'Seconds',
    timerUnitMinutes: 'min',
    timerUnitSeconds: 'sec',
    timerRange: 'Between 0 and 59',

    buzzerTitle: 'Buzzer',
    buzzerAction: 'Buzz',
    buzzerHint: 'Tap to buzz',
    buzzerCount: '{count} presses',
    buzzerReset: 'Reset the counter',
    ...
    wheelAddEntry: 'Add',
    wheelRemoveEntry: 'Remove this entry',
