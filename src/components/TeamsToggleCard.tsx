        ...
        <>
          ...
          <View style={styles.settingSubRow}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Pressable onPress={() => onTeamCountChange(Math.max(2, teamCount - 1))} hitSlop={8}>
              ...
              <Pressable onPress={() => onTeamCountChange(Math.min(8, teamCount + 1))} hitSlop={8}>
          ...
          <View style={styles.settingSubRow}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
              <Pressable onPress={() => onPlayersPerTeamChange(Math.max(1, playersPerTeam - 1))} hitSlop={8}>
              ...
              <Pressable onPress={() => onPlayersPerTeamChange(Math.min(5, playersPerTeam + 1))} hitSlop={8}>
