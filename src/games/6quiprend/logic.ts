...
import { sixquiprendConfig } from './config';

export const sixquiprendeEngine: GameEngine = {
  config: sixquiprendConfig,
  ...
  checkEndGame(scores, players, scoreLimit?) {
    ...
    const limit = scoreLimit ?? sixquiprendConfig.scoreLimit ?? 500;
